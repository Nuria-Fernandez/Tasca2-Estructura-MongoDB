...
db.createCollection( 'Pedido', {validator: {$jsonSchema: {bsonType: 'object',title:'Pedido',required: [         'idPedido'],properties: {idPedido: {bsonType: 'objectId'},DetallePedido: {bsonType: 'array',items: {
